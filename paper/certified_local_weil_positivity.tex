...
\hypersetup{
  pdftitle={Certified Local Weil Positivity for the Riemann Zeta Function in the Even Pole-Moment-Null Sector through Radius 3/5},
...
\title{Certified Local Weil Positivity for the Riemann Zeta Function
in the Even Pole-Moment-Null Sector through Radius \(3/5\)}
\author{Sharan Thota}
\date{}
...
\medskip
\noindent\textbf{2020 Mathematics Subject Classification.} 11M26, 47A07, 47B65, 65G40.

\smallskip
\noindent\textbf{Keywords.} Weil's criterion, Riemann zeta function,
localized quadratic form, validated numerics, interval arithmetic, Poisson frame, Schur complement.
...
Recent finite-element and finite-Galerkin studies provide detailed numerical or finite-dimensional information,
but not a lower bound for the exact infinite-dimensional pole-moment-null continuum form \cite{KimEtAl2026,Groskin2026}.
...
Section~\ref{pub-sec-weil-form} fixes the Fourier normalization, form domain, and all-radius criterion.
...
\subsection{Fourier normalization and the moment constraint}
...
\subsection{The all-radius criterion}

The following proposition fixes the precise relation between the local problem and the classical Weil criterion.
It is included to delimit the scope of Theorem~\ref{pub-thm-main}.
...
No converse from positivity on a single bounded interval of radii is used or claimed.
\end{remark}
...
the smallest having lower endpoint
\begin{equation}
                  0.0097928496566488328.
...
By Proposition~\ref{pub-prop-rh-equivalence},
that all-radius extension is an RH-level problem.
...
The version corresponding to this paper is archived under \href{https://github.com/sharantresearch-ops/certified-local-weil-positivity/tree/v1.0.0}{tag \texttt{v1.0.0}}.
...
\newblock A numerical realization of Suzuki's Weil-quadratic-form operator:
the archimedean spectral law, its universality, and an operator form of
Weil's positivity criterion,
\newblock arXiv:2607.24830v2 (2026).
\newblock \url{https://arxiv.org/abs/2607.24830}.
